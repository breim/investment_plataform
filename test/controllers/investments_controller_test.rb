...
class InvestmentsControllerTest < ActionController::TestCase
  ...
  test "should create investment" do
    assert_difference('Investment.count') do
      post :create, investment: { project_id: @investment.project_id, user_id: @investment.user_id, value: @investment.value }
    end
  ...
  test "should update investment" do
    patch :update, id: @investment, investment: { project_id: @investment.project_id, user_id: @investment.user_id, value: @investment.value }
    assert_redirected_to investment_path(assigns(:investment))
  end
